...
- (instancetype)initWithMainContentViewController:(PFWeatherReportViewController *)mainContentViewController
{
...
- (void)showCitiesListController
{
    if (_sideViewState != PFSideViewStateShowing)
    {
        ...
        PFCitiesListViewController *citiesListViewController = self.citiesListViewControllerProvider();
        
        _citiesListController = [[UINavigationController alloc] initWithRootViewController: citiesListViewController];
...
- (void)showAddCitiesController
{
    if (!_addCitiesController)
    {
        ...
        PFAddCityViewController *addCityViewController = self.addCityViewControllerProvider();

        _addCitiesController = [[UINavigationController alloc] initWithRootViewController: addCityViewController];
